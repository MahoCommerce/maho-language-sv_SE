...
# Swedish (sv_SE) language pack for Maho ecommerce platform

This repository contains the sv_SE language pack for the Maho e-commerce platform.
It provides localization support for the sv_SE language and region.
...
```bash
composer require mahocommerce/maho-language-sv_se
```
